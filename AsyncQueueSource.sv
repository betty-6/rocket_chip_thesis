...
module AsyncQueueSource(
  ...
  always @(posedge clock) begin
    if (_T) begin	// src/main/scala/chisel3/util/Decoupled.scala:52:35
      ...
      mem_0_size <= 2'h2;	// src/main/scala/util/AsyncQueue.scala:71:14, :80:16
  ...
  always @(posedge clock or posedge reset) begin
    if (reset) begin
      widx_widx_bin <= 1'h0;	// src/main/scala/util/AsyncQueue.scala:52:25, :71:14
      ready_reg <= 1'h0;	// src/main/scala/util/AsyncQueue.scala:71:14, :88:56
      widx_gray <= 1'h0;	// src/main/scala/util/AsyncQueue.scala:71:14, :91:55
    end
    else begin
  ...
  `ifndef SYNTHESIS
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        _RANDOM_0 = `RANDOM;
        _RANDOM_1 = `RANDOM;
        mem_0_opcode = _RANDOM_0[2:0];	// src/main/scala/util/AsyncQueue.scala:80:16
        mem_0_param = _RANDOM_0[5:3];	// src/main/scala/util/AsyncQueue.scala:80:16
        mem_0_size = _RANDOM_0[7:6];	// src/main/scala/util/AsyncQueue.scala:80:16
        mem_0_source = _RANDOM_0[8];	// src/main/scala/util/AsyncQueue.scala:80:16
        mem_0_address = _RANDOM_0[17:9];	// src/main/scala/util/AsyncQueue.scala:80:16
        mem_0_mask = _RANDOM_0[21:18];	// src/main/scala/util/AsyncQueue.scala:80:16
        mem_0_data = {_RANDOM_0[31:22], _RANDOM_1[21:0]};	// src/main/scala/util/AsyncQueue.scala:80:16
        mem_0_corrupt = _RANDOM_1[22];	// src/main/scala/util/AsyncQueue.scala:80:16
        widx_widx_bin = _RANDOM_1[23];	// src/main/scala/util/AsyncQueue.scala:52:25, :80:16
        ready_reg = _RANDOM_1[24];	// src/main/scala/util/AsyncQueue.scala:80:16, :88:56
        widx_gray = _RANDOM_1[25];	// src/main/scala/util/AsyncQueue.scala:80:16, :91:55
      `endif // RANDOMIZE_REG_INIT
      `ifdef RANDOMIZE
        if (reset) begin
          widx_widx_bin = 1'h0;	// src/main/scala/util/AsyncQueue.scala:52:25, :71:14
  ...
  AsyncValidSync source_valid_0 (	// src/main/scala/util/AsyncQueue.scala:100:32
    .io_in  (1'h1),	// src/main/scala/util/AsyncQueue.scala:79:28
    .clock  (clock),
