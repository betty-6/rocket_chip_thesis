...
module AsyncQueueSource_2(
  ...
  always @(posedge clock) begin
    if (_T) begin	// src/main/scala/chisel3/util/Decoupled.scala:52:35
      ...
      mem_0_param <= 2'h0;	// src/main/scala/util/AsyncQueue.scala:71:14, :80:16
  ...
  `ifndef SYNTHESIS
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        mem_0_param = _RANDOM_0[4:3];	// src/main/scala/util/AsyncQueue.scala:80:16
        mem_0_size = _RANDOM_0[6:5];	// src/main/scala/util/AsyncQueue.scala:80:16
        mem_0_source = _RANDOM_0[7];	// src/main/scala/util/AsyncQueue.scala:80:16
        mem_0_sink = _RANDOM_0[8];	// src/main/scala/util/AsyncQueue.scala:80:16
        mem_0_denied = _RANDOM_0[9];	// src/main/scala/util/AsyncQueue.scala:80:16
        mem_0_data = {_RANDOM_0[31:10], _RANDOM_1[9:0]};	// src/main/scala/util/AsyncQueue.scala:80:16
        mem_0_corrupt = _RANDOM_1[10];	// src/main/scala/util/AsyncQueue.scala:80:16
        widx_widx_bin = _RANDOM_1[11];	// src/main/scala/util/AsyncQueue.scala:52:25, :80:16
        ready_reg = _RANDOM_1[12];	// src/main/scala/util/AsyncQueue.scala:80:16, :88:56
        widx_gray = _RANDOM_1[13];	// src/main/scala/util/AsyncQueue.scala:80:16, :91:55
      `endif // RANDOMIZE_REG_INIT
      `ifdef RANDOMIZE
        if (reset) begin
          widx_widx_bin = 1'h0;	// src/main/scala/util/AsyncQueue.scala:52:25, :71:14
