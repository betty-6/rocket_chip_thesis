...
module AsyncResetSynchronizerPrimitiveShiftReg_d3_i0(
  ...
  `ifndef SYNTHESIS
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        _RANDOM_0 = `RANDOM;
        sync_0 = _RANDOM_0[0];	// src/main/scala/util/SynchronizerReg.scala:51:87
        sync_1 = _RANDOM_0[1];	// src/main/scala/util/SynchronizerReg.scala:51:87
        sync_2 = _RANDOM_0[2];	// src/main/scala/util/SynchronizerReg.scala:51:87
      `endif // RANDOMIZE_REG_INIT
      `ifdef RANDOMIZE
        if (reset) begin
          sync_0 = 1'h0;	// src/main/scala/util/SynchronizerReg.scala:51:87
