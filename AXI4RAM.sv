  ...
  `ifndef SYNTHESIS
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        _RANDOM_1 = `RANDOM;
        _RANDOM_2 = `RANDOM;
        w_full = _RANDOM_0[0];	// src/main/scala/amba/axi4/SRAM.scala:70:25
        w_id = _RANDOM_0[4:1];	// src/main/scala/amba/axi4/SRAM.scala:70:25, :71:21
        w_echo_real_last = _RANDOM_0[5];	// src/main/scala/amba/axi4/SRAM.scala:70:25, :72:21
        r_sel1 = _RANDOM_0[6];	// src/main/scala/amba/axi4/SRAM.scala:70:25, :73:25
        w_sel1 = _RANDOM_0[7];	// src/main/scala/amba/axi4/SRAM.scala:70:25, :74:25
        r_full = _RANDOM_0[8];	// src/main/scala/amba/axi4/SRAM.scala:70:25, :99:25
        r_id = _RANDOM_0[12:9];	// src/main/scala/amba/axi4/SRAM.scala:70:25, :100:21
        r_echo_real_last = _RANDOM_0[13];	// src/main/scala/amba/axi4/SRAM.scala:70:25, :101:21
        rdata_REG = _RANDOM_0[14];	// src/main/scala/amba/axi4/SRAM.scala:70:25, src/main/scala/util/package.scala:100:91
        rdata_r_0 = _RANDOM_0[22:15];	// src/main/scala/amba/axi4/SRAM.scala:70:25, src/main/scala/util/package.scala:88:63
        rdata_r_1 = _RANDOM_0[30:23];	// src/main/scala/amba/axi4/SRAM.scala:70:25, src/main/scala/util/package.scala:88:63
        rdata_r_2 = {_RANDOM_0[31], _RANDOM_1[6:0]};	// src/main/scala/amba/axi4/SRAM.scala:70:25, src/main/scala/util/package.scala:88:63
        rdata_r_3 = _RANDOM_1[14:7];	// src/main/scala/util/package.scala:88:63
        rdata_r_4 = _RANDOM_1[22:15];	// src/main/scala/util/package.scala:88:63
        rdata_r_5 = _RANDOM_1[30:23];	// src/main/scala/util/package.scala:88:63
        rdata_r_6 = {_RANDOM_1[31], _RANDOM_2[6:0]};	// src/main/scala/util/package.scala:88:63
        rdata_r_7 = _RANDOM_2[14:7];	// src/main/scala/util/package.scala:88:63
      `endif // RANDOMIZE_REG_INIT
    end // initial
