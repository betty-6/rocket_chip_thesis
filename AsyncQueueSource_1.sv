...
module AsyncQueueSource_1(
  ...
  `ifndef SYNTHESIS
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        _RANDOM_0 = `RANDOM;
        mem_0_resumereq = _RANDOM_0[0];	// src/main/scala/util/AsyncQueue.scala:80:16
        mem_0_hartsel = _RANDOM_0[10:1];	// src/main/scala/util/AsyncQueue.scala:80:16
        mem_0_ackhavereset = _RANDOM_0[11];	// src/main/scala/util/AsyncQueue.scala:80:16
        mem_0_hasel = _RANDOM_0[12];	// src/main/scala/util/AsyncQueue.scala:80:16
        mem_0_hamask_0 = _RANDOM_0[13];	// src/main/scala/util/AsyncQueue.scala:80:16
        mem_0_hrmask_0 = _RANDOM_0[14];	// src/main/scala/util/AsyncQueue.scala:80:16
        widx_widx_bin = _RANDOM_0[15];	// src/main/scala/util/AsyncQueue.scala:52:25, :80:16
        ready_reg = _RANDOM_0[16];	// src/main/scala/util/AsyncQueue.scala:80:16, :88:56
        widx_gray = _RANDOM_0[17];	// src/main/scala/util/AsyncQueue.scala:80:16, :91:55
      `endif // RANDOMIZE_REG_INIT
      `ifdef RANDOMIZE
        if (reset) begin
          widx_widx_bin = 1'h0;	// src/main/scala/util/AsyncQueue.scala:52:25, :71:14
