...
module data_arrays_0_combMem_0(	// src/main/scala/util/DescribedSRAM.scala:17:26
  input  [8:0]   RW0_addr,
  input          RW0_en,
                 RW0_clk,
                 RW0_wmode,
  ...
  `ifndef SYNTHESIS	// src/main/scala/util/DescribedSRAM.scala:17:26
    `ifdef RANDOMIZE_MEM_INIT	// src/main/scala/util/DescribedSRAM.scala:17:26
      integer initvar;	// src/main/scala/util/DescribedSRAM.scala:17:26
  ...
  assign RW0_rdata = _GEN_0 & ~_GEN_1 ? Memory[_GEN] : 256'bx;	// src/main/scala/util/DescribedSRAM.scala:17:26
endmodule
