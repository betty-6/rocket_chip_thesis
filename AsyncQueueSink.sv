...
module AsyncQueueSink(
  ...
  always @(posedge clock or posedge reset) begin
    if (reset) begin
      ridx_ridx_bin <= 1'h0;	// src/main/scala/util/AsyncQueue.scala:52:25, :144:77
      valid_reg <= 1'h0;	// src/main/scala/util/AsyncQueue.scala:144:77, :161:56
      ridx_gray <= 1'h0;	// src/main/scala/util/AsyncQueue.scala:144:77, :164:55
    end
    else begin
  ...
  `ifndef SYNTHESIS
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        _RANDOM_0 = `RANDOM;
        ridx_ridx_bin = _RANDOM_0[0];	// src/main/scala/util/AsyncQueue.scala:52:25
        valid_reg = _RANDOM_0[1];	// src/main/scala/util/AsyncQueue.scala:52:25, :161:56
        ridx_gray = _RANDOM_0[2];	// src/main/scala/util/AsyncQueue.scala:52:25, :164:55
      `endif // RANDOMIZE_REG_INIT
      `ifdef RANDOMIZE
        if (reset) begin
          ridx_ridx_bin = 1'h0;	// src/main/scala/util/AsyncQueue.scala:52:25, :144:77
  ...
  AsyncValidSync sink_valid_0 (	// src/main/scala/util/AsyncQueue.scala:168:33
    .io_in  (1'h1),	// src/main/scala/util/AsyncQueue.scala:143:30
    .clock  (clock),
